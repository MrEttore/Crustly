...
export default function Button({ children, disabled, to, type, onClick }) {
    ...
    const styles = {
        primary: base + ' bg-primary text-cream hover:bg-primary-dark hover:text-gold px-6 py-3',
        small: base + ' bg-primary text-cream hover:bg-primary-dark hover:text-gold px-4 py-2 text-sm',
        secondary:
        ...
        round: base + ' bg-gold text-primary-dark hover:bg-primary hover:text-gold px-3 py-1 text-sm',
    };
